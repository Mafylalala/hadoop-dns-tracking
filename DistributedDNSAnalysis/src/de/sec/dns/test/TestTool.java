...
public class TestTool extends Configured implements Tool {
	 ...
	 */
	private static String ACTION = "Test";
	...
	public int run(String[] args) throws Exception {
		...
		String jobName = Util.JOB_NAME + " [" + TestTool.ACTION + "] {dataset="
				+ datasetPath + ", header=" + conf.get(Util.CONF_HEADER_PATH)
				+ ", option=" + conf.get(Util.CONF_OPTIONS) + ", traindate="
		...
		conf.set(
				...
				"-Xms2000m -Xmx3000m -XX:+UseConcMarkSweepGC -XX:+CMSIncrementalMode -XX:-UseGCOverheadLimit");
