 ...
 */
public class JaccardTestTool extends Configured implements Tool {
	/**
	 ...
	 */
	private static String ACTION = "JaccardTest";
	...
	public int run(String[] args) throws Exception {
		...
		String jobName = Util.JOB_NAME + " [" + JaccardTestTool.ACTION
		...
		job.setJarByClass(JaccardTestTool.class);
		job.setMapperClass(JaccardTestMapper.class);
