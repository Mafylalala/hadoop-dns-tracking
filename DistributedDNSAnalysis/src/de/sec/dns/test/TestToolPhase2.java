 ...
 */
public class TestToolPhase2 extends Configured implements Tool {
	/**
	 ...
	 */
	private static String ACTION = "Test Phase Two";
	...
	public int run(String[] args) throws Exception {
		...
		String jobName = Util.JOB_NAME + " [" + TestToolPhase2.ACTION
		...
		job.setJarByClass(TestToolPhase2.class);
		job.setMapperClass(TestMapperPhase2.class);
