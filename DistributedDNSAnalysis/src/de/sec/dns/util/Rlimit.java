...
public class Rlimit {
	...
	private static final String NATIVE_LIBRARY = "rlimit";
	...
	public final static int RLIMIT_RSS = 5; // resident set size
	public final static int RLIMIT_PROC = 6; // resident set size
	public final static int RLIMIT_NOFILE = 7; // file descriptors
	public final static int RLIMIT_AS = 9;
	public final static int RLIMIT_NLIMITS = 15; // number of resource limits

	public final static long RLIM_INFINITY = -1;
	...
	static {
		try {
			System.out.println("trying to load "
					+ System.mapLibraryName(NATIVE_LIBRARY));
	 ...
	 * 
	 * @param resource
	 *            Resource to get limits for. Must be one of RLIMIT_* constants.
	 * 
